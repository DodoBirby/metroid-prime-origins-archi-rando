...
// -- MW Changes Start
selection_vertical(18, sndPauseScroll);
// -- MW Changes End
...
// -- MW Changes Start
if (global.key_accept && (selection == 4 || selection == 18) && !global.key_up && !global.key_down && !global.key_left && !global.key_right)
{
    // -- MW Changes End
...
// -- MW Changes Start
if ((global.key_left_tap || global.key_left_repeat) && selection != 4 && selection != 18 && !global.key_up && !global.key_down)
{
    // -- MW Changes End
    ...
    if (selection == 16)
    {
        ds_add_options("TimerOnScreen", -1);
    }
    if (ds_zero_options("TimerOnScreen") < 0)
    {
        ds_write_options("TimerOnScreen", 3);
    }
    // -- MW Changes Start
    if (selection == 17)
    {
        ds_add_options("Mouse Capture", -1);
    }
    if (ds_zero_options("Mouse Capture") < 0)
    {
        ds_write_options("Mouse Capture", 1);
    }
    // -- MW Changes End
}
// -- MW Changes Start
if ((global.key_right_tap || global.key_right_repeat || global.key_accept) && selection != 4 && selection != 18 && !global.key_up && !global.key_down)
{
    // -- MW Changes End
    bitsound(sndPauseScroll);
    if (selection == 0)
    ...
    if (ds_zero_options("TimerOnScreen") > 3)
    {
        ds_write_options("TimerOnScreen", 0);
    }
    ...
    if (ds_zero_options("Mouse Capture") > 1)
    {
        ds_write_options("Mouse Capture", 0);
    }
    // -- MW Changes End
}
