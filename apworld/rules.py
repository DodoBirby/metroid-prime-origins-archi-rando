...
def set_location_rules(world: MetroidPrimeOriginsWorld):
    ...
    set_location_rule("(Chozo Ruins) Main Plaza - Boost Ball Ramp", CAN_BOOST, world)
    # Kill the nest and do a low overhang move or just IBJ/grapple
    set_location_rule("(Chozo Ruins) Main Plaza - Lower Ledge", (Has("Missile Tank") & CAN_TRAVERSE_LOW_OVERHANG) | Has("Grapple Beam") | CAN_IBJ | Has("Enter Main Plaza From Ledge"), world)
    set_location_rule("(Chozo Ruins) Main Plaza - Top Ledge", Has("Grapple Beam") | CAN_IBJ, world)
    set_location_rule("(Chozo Ruins) Ruined Nursery", CAN_DESTROY_BOMB_BLOCKS & Has("Morph Ball"), world)
    ...
    set_location_rule("(Chozo Ruins) Ruined Fountain", CAN_BOOST | CAN_SPIDER, world)
    ...
    set_location_rule("(Chozo Ruins) Watery Hall - Underwater Tunnel", Has("Missile Tank") & Has("Gravity Suit"), world)
    ...
    set_location_rule("(Chozo Ruins) Furnace - Boost Ceiling", CAN_BOOST & CAN_SPIDER & CAN_DESTROY_BOMB_BLOCKS, world)

    set_location_rule("(Chozo Ruins) Crossway", CAN_BOOST & CAN_BOMB, world)
    ...
    set_location_rule("(Chozo Ruins) Tower Chamber", Has("Gravity Suit") & Has("Wave Beam"), world)
