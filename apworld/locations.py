...
LOCATION_TABLE: dict[str, LocationData] = {
    "(Chozo Ruins) Sunchamber - Ghost Reward": LocationData("Artifact 4 cho_Sunchamber x320 y224"),
    "(Chozo Ruins) Sunchamber - Flaahgra Reward": LocationData("Varia Suit cho_Sunchamber x56 y320"),
    "(Chozo Ruins) Tower Chamber": LocationData("Artifact 5 cho_Tower_Chamber x160 y112"),
    "(Chozo Ruins) Elder Chamber": LocationData("Artifact 10 cho_Elder_Chamber x152 y72"),
    "(Chozo Ruins) Ruined Shrine - Bug Fight Reward": LocationData("Morph Ball cho_Ruined_Shrine x672 y128"),
    "(Chozo Ruins) Watery Hall - Top": LocationData("Charge Beam cho_Watery_Hall x480 y104"),
    "(Chozo Ruins) Antechamber": LocationData("Ice Beam cho_Antechamber x152 y176"),
    "(Chozo Ruins) Tower of Light": LocationData("Wavebuster cho_Tower_of_Light x151 y65"),
    "(Chozo Ruins) Furnace - Chamber": LocationData("Energy Tanks Max cho_Furnace_subC x160 y112"),
    "(Chozo Ruins) Furnace - Boost Ceiling": LocationData("Missiles Max cho_Furnace_subD x288 y32"),
    "(Chozo Ruins) Hall of the Elders - Ceiling": LocationData("Energy Tanks Max cho_Hall_of_the_Elders x384 y32"),
    "(Chozo Ruins) Training Chamber": LocationData("Energy Tanks Max cho_Training_Chamber x392 y72"),
    "(Chozo Ruins) Transport Access North": LocationData("Energy Tanks Max cho_Transport_Access_North x152 y134"),
    "(Chozo Ruins) Burn Dome - Fight Reward": LocationData("Morph Ball Bomb cho_Burn_Dome x152 y160"),
    "(Chozo Ruins) Burn Dome - Back Room": LocationData("Missiles Max cho_Burn_Dome_subB x208 y112"),
    "(Chozo Ruins) Crossway": LocationData("Missiles Max cho_Crossway x16 y48"),
    "(Chozo Ruins) Dynamo - Top": LocationData("Missiles Max cho_Dynamo x224 y32"),
    "(Chozo Ruins) Dynamo - Bottom": LocationData("Missiles Max cho_Dynamo x272 y368"),
    "(Chozo Ruins) Gathering Hall": LocationData("Missiles Max cho_Gathering_Hall x280 y24"),
    "(Chozo Ruins) Hive Totem": LocationData("Missiles Max cho_Hive_Totem x152 y144"),
    "(Chozo Ruins) Main Plaza - Lower Ledge": LocationData("Energy Tanks Max cho_Main_Plaza x104 y256"),
    "(Chozo Ruins) Main Plaza - Boost Ball Ramp": LocationData("Missiles Max cho_Main_Plaza x120 y520"),
    "(Chozo Ruins) Main Plaza - Super Missile Blocks": LocationData("Missiles Max cho_Main_Plaza x584 y456"),
    "(Chozo Ruins) Main Plaza - Top Ledge": LocationData("Missiles Max cho_Main_Plaza x64 y80"),
    "(Chozo Ruins) Ruined Fountain": LocationData("Missiles Max cho_Ruined_Fountain x576 y160"),
    "(Chozo Ruins) Ruined Gallery - Left Wall": LocationData("Missiles Max cho_Ruined_Gallery x48 y336"),
    "(Chozo Ruins) Ruined Gallery - Right Tunnel": LocationData("Missiles Max cho_Ruined_Gallery x592 y248"),
    "(Chozo Ruins) Ruined Nursery": LocationData("Missiles Max cho_Ruined_Nursery x352 y320"),
    "(Chozo Ruins) Ruined Shrine - Ceiling": LocationData("Missiles Max cho_Ruined_Shrine x272 y32"),
    "(Chozo Ruins) Ruined Shrine - Tunnel": LocationData("Missiles Max cho_Ruined_Shrine x904 y168"),
    "(Chozo Ruins) Training Chamber Access": LocationData("Missiles Max cho_Training_Chamber_Access x288 y144"),
    "(Chozo Ruins) Vault": LocationData("Missiles Max cho_Vault x192 y112"),
    "(Chozo Ruins) Watery Hall - Underwater Tunnel": LocationData("Missiles Max cho_Watery_Hall x560 y288"),
    "(Chozo Ruins) Watery Hall Access": LocationData("Missiles Max cho_Watery_Hall_Access x151 y135"),
    "(Chozo Ruins) Magma Pool": LocationData("Power Bombs Max cho_Magma_Pool x584 y168"),
