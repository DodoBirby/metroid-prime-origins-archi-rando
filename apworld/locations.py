...
LOCATION_TABLE: dict[str, LocationData] = {
    ...
    "(Magmoor Caverns) Transport Tunnel A": LocationData("Energy Tanks Max mag_Transport_Tunnel_A x160 y48", "(Magmoor Caverns) Central Magmoor"),
    "(Magmoor Caverns) Fiery Shores - from Warrior Shrine": LocationData("Power Bombs Max mag_Fiery_Shores x576 y32", "(Magmoor Caverns) Central Magmoor"),
    "(Magmoor Caverns) Storage Cavern": LocationData("Missiles Max mag_Storage_Cavern x48 y80", "(Magmoor Caverns) Central Magmoor"),
    "(Magmoor Caverns) Triclops Pit": LocationData("Missiles Max mag_Triclops_Pit x512 y64", "(Magmoor Caverns) Central Magmoor"),

    "(Magmoor Caverns) Lava Lake - Rock Spire": LocationData("Artifact 8 mag_Lava_Lake_subC x274 y78", "(Magmoor Caverns) East Magmoor"),

    "(Magmoor Caverns) Plasma Processing": LocationData("Plasma Beam mag_Plasma_Processing x192 y128", "(Magmoor Caverns) Geothermal Core"),

    "(Magmoor Caverns) Magmoor Workstation": LocationData("Energy Tanks Max mag_Magmoor_Workstation x568 y377", "(Magmoor Caverns) West Magmoor"),
    ...
    "(Phendrana Drifts) Research Lab Aether - Hidden Passage": LocationData("Missiles Max phe_Research_Lab_Aether x352 y192", "(Phendrana Drifts) Research Lab Aether"),

    "(Phendrana Drifts) Chozo Ice Temple - Frozen Floor": LocationData("Artifact 9 phe_Chozo_Ice_Temple_subD x168 y152", "(Phendrana Drifts) Ice Temple"),
    "(Phendrana Drifts) Chapel of the Elders": LocationData("Wave Beam phe_Chapel_of_the_Elders_subB x144 y136", "(Phendrana Drifts) Ice Temple"),

    "(Phendrana Drifts) Storage Cave": LocationData("Artifact 11 phe_Storage_Cave x184 y120", "(Phendrana Drifts) True Edge"),

    "(Phendrana Drifts) Quarantine Cave - Thardus Reward": LocationData("Spider Ball phe_Quarantine_Cave x320 y298.67", "(Phendrana Drifts) Thardus Area"),
    "(Phendrana Drifts) Quarantine Monitor": LocationData("Missiles Max phe_Quarantine_Monitor x184 y128", "(Phendrana Drifts) Thardus Area"),

    "(Phendrana Drifts) Research Core": LocationData("Spazer phe_Research_Core x160 y552", "(Phendrana Drifts) Research Core"),

    "(Phendrana Drifts) Gravity Chamber": LocationData("Gravity Suit phe_Gravity_Chamber x80 y96", "(Phendrana Drifts) Hunter Cave"),
    "(Phendrana Drifts) Gravity Chamber - Spike Tunnel": LocationData("Missiles Max phe_Gravity_Chamber_subB x56 y32", "(Phendrana Drifts) Hunter Cave"),

    "(Phendrana Drifts) Observatory": LocationData("Super Missile phe_Observatory x304 y56", "(Phendrana Drifts) Top Observatory"),

    "(Phendrana Drifts) Ruined Courtyard": LocationData("Energy Tanks Max phe_Ruined_Courtyard x16 y400", "(Phendrana Drifts) Central Phendrana"),

    "(Phendrana Drifts) Transport Access": LocationData("Energy Tanks Max phe_Transport_Access x160 y160", "(Phendrana Drifts) Phendrana Edge Lower"),

    "(Phendrana Drifts) Frost Cave": LocationData("Missiles Max phe_Frost_Cave x296 y392", "(Phendrana Drifts) Frost Cave"),

    "(Phendrana Drifts) Phendrana Canyon": LocationData("Boost Ball phe_Phendrana_Canyon_subB x144 y112", "(Phendrana Drifts) Shorelines"),
    "(Phendrana Drifts) Ice Ruins East - Tunnel": LocationData("Missiles Max phe_Ice_Ruins_East x16 y32", "(Phendrana Drifts) Shorelines"),
    "(Phendrana Drifts) Ice Ruins East - Ice Cube": LocationData("Missiles Max phe_Ice_Ruins_East x368 y256", "(Phendrana Drifts) Shorelines"),
    "(Phendrana Drifts) Phendrana Shorelines - Underwater Ice Cube": LocationData("Missiles Max phe_Phendrana_Shorelines_subB x112 y832", "(Phendrana Drifts) Shorelines"),
    "(Phendrana Drifts) Phendrana Shorelines - Hidden Tunnel": LocationData("Missiles Max phe_Phendrana_Shorelines_subB x544 y256", "(Phendrana Drifts) Shorelines"),
    "(Phendrana Drifts) Ice Ruins West": LocationData("Power Bombs Max phe_Ice_Ruins_West x360 y248", "(Phendrana Drifts) Shorelines"),

    "(Phendrana Drifts) Research Lab Hydra": LocationData("Missiles Max phe_Research_Lab_Hydra_subB x376 y160", "(Phendrana Drifts) Research Lab Hydra"),

    "(Phendrana Drifts) Security Cave": LocationData("Power Bombs Max phe_Security_Cave x168 y120", "(Phendrana Drifts) True Edge"),
